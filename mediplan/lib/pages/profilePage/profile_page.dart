                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10.0),
                        Obx(
                          () => widget.control.password.isNotEmpty
                              ? CustomTextLabel(
                                  label: 'Contraseña',
                                  text: '********')
                              : CustomTextLabel(label: 'Contraseña', text: '---------'),
                        ),
                        SizedBox(height: 10.0),
                        Obx(
  ...
  Widget _buildBodyEdit(BuildContext context) {
    return SafeArea(
      ...
      children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Customtextfield(
                            label: 'Contraseña',
                            controller: widget.control.txtpassword,
                            hintText: 'Ingrese su contraseña',
                          ),
                          Obx(() => widget.control.passwordError.isNotEmpty
                              ? Padding(
                                  padding: EdgeInsets.only(left: 15.0),
                                  child: Text(
                                    widget.control.passwordError.value,
                                    style: TextStyle(color: Colors.red),
                                  ),
                                )
                              : SizedBox()),
        ...
        Obx(() {
          if (widget.control.isLoading.value) {
            return Container(
